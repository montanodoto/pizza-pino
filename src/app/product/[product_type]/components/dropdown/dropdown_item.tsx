...
export default function DropdownItem({
  ...
  const is_initial_active = useMemo(() => active, [active]);

  const tmp = !is_selected ? is_initial_active : is_selected;
        ...
        <div className="card--topping__list__topping__gutter">
          ...
          {is_double_enabled && (
            <span
              ...
              className={`card--topping__list__topping__control card--topping__list__topping__control--2x ${
                doubled && "selected"
              } `}
              rel="P"
              data-single="true"
